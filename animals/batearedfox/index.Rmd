...
categories: ["animals"]
tags: ["animals"]
image: "/img/backgrounds/BatEaredFox.jpg"
output:
  blogdown::html_page
...
knitr::include_graphics("img/BatEaredFox.jpg", error = F)
```
...
knitr::include_graphics("img/BatEaredFoxDistribution.png", error = F)
```
...
knitr::include_graphics("img/BatEaredFoxToying.jpg", error = F)
```
